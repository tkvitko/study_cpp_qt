    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this, &MainWindow::data_ready, this, &MainWindow::on_dataReady);
...
void MainWindow::send_data_ready(QVector<double> data)
{
...
void MainWindow::on_pb_start_clicked()
{
    ...
    auto findMax = [&](QVector<double> res){
                                                 ...
                                                 */
                                                QVector<double> firstData = res.mid(0, FD);
                                                this->send_data_ready(firstData);
...
void MainWindow::on_dataReady(QVector<double> data)
{
    graphicWindow->draw_graphic(data);
    graphicWindow->show();
}
